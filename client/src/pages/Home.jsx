          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Easily search for healthcare professionals based on specialty,
                location, and availability. Connect with trusted doctors to get
                the care you need.
              </p>
        ...
        <div className="col-md-6">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Quickly access critical emergency contact numbers, first aid
                tips, and nearby hospital locations. Be prepared for any
                situation with our comprehensive resources.
              </p>
        ...
        <div className="col-md-12">
          <div className="card shadow">
            <div className="card-body">
              ...
              <p className="card-text">
                Upload images or PDFs to share important medical documents with
        ...
        <div className="col-md-12">
          <div className="card shadow">
            <div className="card-body">
              ...
              <p className="card-text">
                Use the form below to send a message to your healthcare
                provider.
              </p>
              <textarea
                className="form-control mb-3"
